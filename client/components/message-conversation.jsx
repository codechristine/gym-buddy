        ...
        <div className="conversation__container">
          ...
          <div className="conversation__container-input">
            <form className="conversation__form" onSubmit={this.handleSubmit}>
              <input value={messageVal} type="text" name="message" className="conversation__input" placeholder="Enter message here" onChange={this.handleChange} autoComplete="off" maxLength="130" />
